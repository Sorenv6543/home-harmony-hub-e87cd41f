  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/2f95be49-7080-40cd-94b3-434e70261cd9/id-preview-12ef6a0a--78ea11fe-3800-40da-9ce8-305fcb7a5129.lovable.app-1784192747154.png",
      },
      {
        name: "twitter:image",
        content:
